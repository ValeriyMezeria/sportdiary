...
-- Время создания: Ноя 28 2015 г., 14:48
...
(5, 'Спринт 200м', 'Бег с максимально возможной скоростью на 100м, олимпийская дисциплина.', NULL, 'сек', 1),
...
INSERT INTO `kinds_of_sport` (`id`, `name`, `description`, `type`) VALUES
...
(2, 'Велоспорт', 'Перемещение по земле с использованием транспортных средств (велосипедов), движимых мускульной силой человека.', 'Циклический'),
(3, 'Ходьба', 'Один из способов перемещения человека и животных; осуществляется в результате сложной координированной деятельности скелетных мышц и конечностей, в каждый момент времени хотя бы одна конечность касается земли.', 'Циклический'),
(4, 'Беговые лыжи', 'Совокупность различных видов зимнего спорта, в соревнованиях по которым спортсмены используют  беговые лыжи.', 'Циклический'),
(5, 'Плавание', 'Вид спорта или спортивная дисциплина, заключающаяся в преодолении вплавь за наименьшее время различных дистанций.', 'Циклический');
